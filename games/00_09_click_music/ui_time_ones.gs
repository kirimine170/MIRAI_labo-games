...
onflag { last_digit_value = -1; last_warning_value = -1; hide; }
on "ui_show" { if game_state == "playing" { update_digit; } }
on "ui_time_update" { if game_state == "playing" { update_digit; } }
on "ui_hide" { last_digit_value = -1; last_warning_value = -1; hide; }
