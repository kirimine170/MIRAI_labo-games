...
proc update_digit {
    ...
    digit_value = floor (hit_done / 10);
    if digit_value == last_digit_value { stop_this_script; }
...
onflag { last_digit_value = -1; hide; }
on "ui_show" { if game_state == "playing" { update_digit; } }
on "ui_hit_update" { if game_state == "playing" { update_digit; } }
on "ui_hide" { last_digit_value = -1; hide; }
